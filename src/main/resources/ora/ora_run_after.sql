...
/
CREATE OR REPLACE TRIGGER TR_PRODUCT_ACCESS_LINES BEFORE INSERT ON ACCESS_LINES FOR EACH ROW
WHEN (new.id IS NULL) BEGIN SELECT PRODUCT_SEQ.NEXTVAL INTO :new.id FROM dual; END;
/
CREATE OR REPLACE TRIGGER TR_PRODUCT_BUSINESS_VPN BEFORE INSERT ON BUSINESS_VPN FOR EACH ROW
WHEN (new.id IS NULL) BEGIN SELECT PRODUCT_SEQ.NEXTVAL INTO :new.id FROM dual; END;
/
