...
<div id="calculations-order">
  <div class="span-12 last" style="overflow: hidden;">
    <form:form action="${flowExecutionUrl}">
      <h2 style="margin-left: 20px;"><spring:message code="compendiumForm.title"/></h2>
      ...
      <div id="buttons" style="margin-left: 20px;margin-top: 10px;">
        <p>
          <button type="submit" id="cost" name="_eventId_cost"><spring:message code="button.flow.man_hour"/></button>
        </p>
      </div>
    </form:form>
  </div>
