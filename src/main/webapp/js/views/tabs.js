"use strict";
define(['text!templates/tabs.html', 'views/tab1', 'views/tab2', 'views/tab3', 'jquery', 'underscore', 'backbone', 'jquery_ui'],
    function (template, Tab1View, Tab2View, Tab3View, $, _, Backbone) {
